...
@section('content')
    ...
    <div class="org-budget-page-grid">
        ...
        {{-- 4. Bottom Section: Expense Log (Full width on OSO) & Record New Expense Form (Hidden on OSO) --}}
        <div class="org-budget-bottom-split {{ $isOso ? 'is-oso-full' : '' }}">
            {{-- Left: Expense Log --}}
            ...
            {{-- Right: Record New Expense Form (Removed for OSO Officer Interface) --}}
            @if (!$isOso)
            <section class="org-budget-card-panel">
